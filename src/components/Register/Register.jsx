    ...
    <div className="main-Register">
      <div className="left-side">
        ...
        <p>
          ...
          necessitatibus temporibus excepturi vero similique deleniti blanditiis
          reiciendis eligendi id voluptate dicta odit repellendus dolore, sint
          consequuntur minus unde laborum!
        </p>
      </div>
